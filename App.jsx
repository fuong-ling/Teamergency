            ...
            <article className="discover-card" key={friend.connection_id}>
              ...
              <div className="hero-actions">
                <button
                  ...
                  disabled={!canMatch}
                  title={canMatch ? 'You both have compatible team requests.' : 'No compatible team request right now.'}
              ...
              {!canMatch && <p className="note">No compatible team request right now.</p>}
                  </>
                );
              })()}
            </article>
        ...
        <div className="modal-backdrop" role="presentation">
          <section className="connect-modal" role="dialog" aria-modal="true" aria-label="Match plus confirmation">
              ...
              <label>
                ...
                >
                  {state.matchTarget.match_options.map((option, index) => (
                    <option value={index} key={`${option.current_request_id}-${option.friend_request_id}`}>
                      {option.course_name || 'Course'} {option.course_code ? `(${option.course_code})` : ''} | {option.class_day} {option.class_start_time}
                    </option>
                  ))}
                </select>
              </label>
            ...
            {(() => {
              ...
              return option ? (
                <div className="request-summary-box">
                  <p className="eyebrow">Compatible Request</p>
