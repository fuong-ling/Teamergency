...
demo_requests (
  ...
  values
    ...
    ('Jamie Vo', 'SCD', 'Digital Media', 'Digital Media Studio 4', 'COMM2784', 'Tuesday 09:30', array['UI/UX', 'Creative Coding'], 2, array['Enjoys collaborative work', 'Communicates frequently'], 'Demo DMS4 request for visual production matches.'),
    ('Gia Phan', 'SCD', 'Digital Media', 'Digital Media Studio 4', 'COMM2784', 'Thursday 13:30', array['Photography', 'TouchDesigner'], 1, array['Organised and structured', 'Takes initiative'], 'Demo DMS4 request for interface and visual design matches.'),
    ('Owen Tran', 'SCD', 'Digital Media', 'Digital Media Studio 4', 'COMM2784', 'Friday 09:30', array['Video Editing', 'Presentation'], 2, array['Flexible with changes', 'Enjoys collaborative work'], 'Demo DMS4 request for interactive media matches.'),
    ('Hana Le', 'SCD', 'Digital Media', 'Digital Media Studio 4', 'COMM2784', 'Tuesday 13:30', array['JavaScript', 'TouchDesigner'], 1, array['Works steadily throughout the project'], 'Demo DMS4 request for motion media matches.'),
    ('Ryan Ho', 'SCD', 'Digital Media', 'Digital Media Studio 4', 'COMM2784', 'Wednesday 09:30', array['UI/UX', 'Content Creation'], 2, array['Likes to finish tasks early', 'Takes initiative'], 'Demo DMS4 request for web prototype matches.'),
    ('Ellie Dang', 'SCD', 'Digital Media', 'Digital Media Studio 4', 'COMM2784', 'Thursday 09:30', array['Video Editing', 'Motion Graphics'], 1, array['Communicates frequently', 'Organised and structured'], 'Demo DMS4 request for concept and documentation matches.'),
